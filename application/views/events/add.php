...
<div class="form_container" style="position: relative;">
    ...
    <div class="title">Add New Event/Activity</div>
	...
	<div class="input_container">
		<div class="input_wrapper" style="grid-column: span 4; margin-top: 10px;">
			...
			<div>
				<?php
				echo form_input('evt_name', '', 'id="evt_name" class="editview" placeholder="Enter event name or description" onclick="EVENTS.validateClear(this.id);"');
				?>
			</div>
		...
		<div class="input_wrapper">
			...
			<div>
				<?php
				echo form_input('evt_start', '', 'id="evt_start" class="editview" placeholder="Enter start date" onclick="EVENTS.validateClear(this.id);"');
				?>
			</div>
		...
		<div class="input_wrapper">
			...
			<div>
				<?php
				echo form_input('evt_end', '', 'id="evt_end" class="editview" placeholder="Enter end date" onclick="EVENTS.validateClear(this.id);"');
				?>
			</div>
		...
		<div class="input_wrapper">
			...
			<div>
				<?php
				echo form_dropdown('evt_type', $dd_event_type, '', 'id="evt_type" class="filterview" onclick="EVENTS.validateClear(this.id);"');
				?>
			</div>
		...
		<div class="input_wrapper">
			...
			<div>
				<?php
				echo form_dropdown('evt_time', $dd_event_time, '', 'id="evt_time" class="filterview" onclick="EVENTS.validateClear(this.id);"');
				?>
			</div>
		...
		<div style="grid-column: span 2" style="position: relative;">
			<div class="input_wrapper">
				...
				<div>
					<?php
					echo form_dropdown('evt_category', $dd_event_category, '', 'id="evt_category" class="filterview" onclick="EVENTS.validateClear(this.id);"');
					?>
				</div>
		...
		<div class="input_wrapper">
			...
			<div>
				<?php
				echo form_dropdown('evt_free_paid', $dd_event_price, '', 'id="evt_free_paid" class="filterview" onclick="EVENTS.validateClear(this.id);"');
				?>
			</div>
		...
		<div class="input_wrapper">
			...
			<div>
				<?php
				echo form_input('evt_entrance_fee', '', 'id="evt_entrance_fee" class="editview" placeholder="Enter entrance fee" onclick="EVENTS.validateClear(this.id);"');
				?>
			</div>
		...
		<div style="grid-column: span 2">
			<div class="input_wrapper">
				...
				<div>
					<?php
					echo form_dropdown('evt_area', $dd_event_area, '', 'id="evt_area" class="filterview" onclick="EVENTS.validateClear(this.id);"');
					?>
				</div>
		...
		<div style="grid-column: span 2">
			<div class="input_wrapper">
				...
				<div>
					<?php
					echo form_input('evt_location', '', 'id="evt_location" class="editview" placeholder="Enter location" onclick="EVENTS.validateClear(this.id);"');
					?>
				</div>
	...
	<div class="button_bar">
		<div style="display: grid; grid-template-columns: 1fr auto auto 1fr; column-gap: 10px;">
			<div>&nbsp;</div>
			<div class='button_wrapper' onclick="EVENTS.validate(0);">
			<!-- CATEGORIES.save_form(); -->
